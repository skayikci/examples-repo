...
public final class GreeterGrpc {
  ...
  public static final String SERVICE_NAME = "grpcserver.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpcserver.Hello.HelloRequest,
      com.example.grpcserver.Hello.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.grpcserver.Hello.HelloRequest.class,
      responseType = com.example.grpcserver.Hello.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.grpcserver.Hello.HelloRequest,
      com.example.grpcserver.Hello.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.grpcserver.Hello.HelloRequest, com.example.grpcserver.Hello.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.grpcserver.Hello.HelloRequest, com.example.grpcserver.Hello.HelloReply>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.grpcserver.Hello.HelloReply.getDefaultInstance()))
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(com.example.grpcserver.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.grpcserver.Hello.HelloReply> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.example.grpcserver.Hello.HelloReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
     ...
     * </pre>
     */
    public com.example.grpcserver.Hello.HelloReply sayHello(com.example.grpcserver.Hello.HelloRequest request) {
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpcserver.Hello.HelloReply> sayHello(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.grpcserver.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpcserver.Hello.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpcserver.Hello.getDescriptor();
    }
